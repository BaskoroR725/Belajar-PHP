...
/**
 * db.php - Konfigurasi Koneksi Database PDO yang Aman
 * Best Practice: Gunakan try-catch, set error mode ke Exception, 
 * dan gunakan charset utf8mb4 untuk mendukung emoji/karakter khusus.
 */
